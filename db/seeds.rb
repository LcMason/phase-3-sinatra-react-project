...
Review.create(comment: "one of the most thought provking films about drugs released in the early nineties", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "The plot is fast paced and intricate with twists, turns, ups and downs.", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "A story of trust and betrayals involving every genre of people there is. No one can be trusted", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "De Niro masterfully depicts the varying and troublesome events that the Bronx offers, contrasting the lifestyles of violent gangsters to the loving and hardworking ones of its honest fathers.", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "portrays urban hood life in Watts, California during the early rand(1..17)990's perfectly and outstandingly.", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "a great no-pretence, gritty, almost old-fashioned film noir gangster movie", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "Despite Being filled with misogyny and stereotypes, Scarface still captivates those fascinated by outlaws and the American Dream", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "Am I my brothers keeper? This movie oozes early 90's street culture", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "a brilliant cinematic masterpiece", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "nonlinear storytelling to graphic violence to dynamite soundtrack choices", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "They're young, they're in love, they rob banks.", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "An absorbing, well made gangster movie", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "Carlito's Way is a slow and engrossing character driven crime drama that will keep you watching even though you know the fate of the main character", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "churns with furious energy as it plunges into the story of the slum gangs of Rio de Janeiro", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "epic journey of crime, drugs, friendship, violence and betrayal", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "groundbreaking and brilliantly made film", gangster_film_id: rand(1..17), critic_id: rand(1..17))
Review.create(comment: "The original was a wonderful film, but the sequel presents more of a challenge", gangster_film_id: rand(1..17), critic_id: rand(1..17))

Critic.create(rating: 4)
Critic.create(rating: 4)
Critic.create(rating: 5)
Critic.create(rating: 4)
Critic.create(rating: 4)
Critic.create(rating: 5)
Critic.create(rating: 3)
Critic.create(rating: 4)
Critic.create(rating: 5)
Critic.create(rating: 3)
Critic.create(rating: 3)
